...
3. Load the Unpacked Theme
- Once Developer mode is enabled, a new bar will appear with three buttons. Click Load unpacked.
- A file browser window will open. Navigate to the folder where you have stored your generated theme files (this should be the folder containing the manifest.json file).
